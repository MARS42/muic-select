...
class MuicSelect extends HTMLElement {
    ...
    static SELECTION_TEMPLATE: string = 'template.muic-select-selection';
    static OPTION_TEMPLATE: string = 'template.muic-select-option';
    ...
    private createSelectionItem(option?: MuiSelectOption): HTMLElement {
        ...
        if (!option) empty.classList.add('muic-empty-selection');
